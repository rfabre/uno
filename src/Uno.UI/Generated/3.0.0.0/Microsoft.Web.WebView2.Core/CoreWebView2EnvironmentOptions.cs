...
namespace Microsoft.Web.WebView2.Core
{
	...
	public  partial class CoreWebView2EnvironmentOptions 
	{
		...
		public  string TargetCompatibleBrowserVersion
		{
			get
			{
				throw new global::System.NotImplementedException("The member string CoreWebView2EnvironmentOptions.TargetCompatibleBrowserVersion is not implemented in Uno.");
			}
			set
			{
		...
		public  string Language
		{
			get
			{
				throw new global::System.NotImplementedException("The member string CoreWebView2EnvironmentOptions.Language is not implemented in Uno.");
			}
			set
			{
		...
		public  bool AllowSingleSignOnUsingOSPrimaryAccount
		{
			get
			{
				throw new global::System.NotImplementedException("The member bool CoreWebView2EnvironmentOptions.AllowSingleSignOnUsingOSPrimaryAccount is not implemented in Uno.");
			}
			set
			{
		...
		public  string AdditionalBrowserArguments
		{
			get
			{
				throw new global::System.NotImplementedException("The member string CoreWebView2EnvironmentOptions.AdditionalBrowserArguments is not implemented in Uno.");
			}
			set
			{
		...
		public  bool ExclusiveUserDataFolderAccess
		{
			get
			{
				throw new global::System.NotImplementedException("The member bool CoreWebView2EnvironmentOptions.ExclusiveUserDataFolderAccess is not implemented in Uno.");
			}
			set
			{
